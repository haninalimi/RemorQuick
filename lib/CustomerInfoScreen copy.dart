...
import 'package:remorquage/OTPverificationScreen%20copy.dart';
import 'package:remorquage/lib/LocationSelectionScreen.dart';
import 'package:remorquage/utils/constants/colors.dart';

class CustomerInfoScreen2 extends StatelessWidget {
  final List<Map<String, dynamic>> selectedCars;

  const CustomerInfoScreen2({Key? key, required this.selectedCars})
    : super(key: key);
          ...
          child: ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => OtpVerificationScreen2(),
                ),
              );
            },
